...
def _build_department_request(dept: SubagentConfig, packet: WorkerTaskPacket) -> str:
    ...
    return (
        ...
        f'{rendered_packet}\n\n'
        'You do not have access to the original user prompt beyond what is included above. Execute only this assignment.'
    )
...
async def _run_department(
    ...
    try:
        ...
        state = {'messages': [HumanMessage(content=_build_department_request(dept, packet))]}
