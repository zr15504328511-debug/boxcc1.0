...
from subagents.executor_live import run_departments, run_single_department
...
CJK_PLANNING_PATTERNS = [_u(r'\u4f01\u5212'), _u(r'\u89c4\u5212'), _u(r'\u7cfb\u5217'), _u(r'\u6ce2\u6bb5'), _u(r'\u4e0a\u65b0'), _u(r'\u8282\u594f'), _u(r'\u5f00\u53d1\u6392\u671f'), _u(r'\u5f00\u53d1\u8282\u594f'), _u(r'\u5b63\u8282'), _u(r'\u6b3e\u5f0f\u7ed3\u6784'), _u(r'\u6a71\u7a97'), _u(r'\u9648\u5217'), _u(r'\u7a7f\u642d'), _u(r'\u642d\u914d'), _u(r'\u6307\u5f15'), _u(r'\u843d\u5730\u6307\u5f15'), 'sku']
CJK_FINANCE_PATTERNS = [_u(r'\u6210\u672c'), _u(r'\u5b9a\u4ef7'), _u(r'\u6bdb\u5229'), _u(r'\u5229\u6da6'), _u(r'\u9884\u7b97'), _u(r'\u552e\u4ef7'), _u(r'\u7ecf\u8425'), _u(r'\u6295\u4ea7\u6bd4'), _u(r'\u76c8\u4e8f'), _u(r'\u5229\u6da6\u7387'), _u(r'\u76d8\u8d27')]
CJK_COPY_PATTERNS = [_u(r'\u6587\u6848'), _u(r'\u5356\u70b9'), _u(r'\u5ba3\u4f20'), _u(r'\u63a8\u5e7f'), _u(r'\u8be6\u60c5\u9875'), _u(r'\u6807\u9898'), _u(r'\u8bdd\u672f'), _u(r'\u79cd\u8349'), _u(r'\u5c0f\u7ea2\u4e66'), _u(r'\u75db\u70b9\u6587\u6848'), _u(r'\u79cd\u8349\u6587\u6848')]
...
def _serialize_result(result, phase: str, packet: WorkerTaskPacket | None, available_skill_packs: list[str] | None = None) -> dict:
    is_rework = bool(packet and any(str(note).startswith('Critic feedback:') for note in packet.notes))
    content = result.content
    if is_rework and content:
        content = '[返工后版本]\\n' + content
    return {'id': result.id, 'name': result.name, 'display_name': result.display_name, 'phase': phase, 'task_packet': packet.model_dump() if packet else None, 'available_skill_packs': available_skill_packs or [], 'status': result.status, 'content': content, 'error': result.error, 'startedAt': result.started_at.isoformat() if result.started_at else None, 'completedAt': result.completed_at.isoformat() if result.completed_at else None, 'is_rework': is_rework}
