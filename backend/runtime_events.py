...
def set_event_emitter(emitter: EventEmitter | None, *, message_id: str | None = None, session_id: str | None = None) -> tuple[contextvars.Token, contextvars.Token, contextvars.Token, contextvars.Token]:
...
def reset_event_emitter(tokens: tuple[contextvars.Token, contextvars.Token, contextvars.Token, contextvars.Token]) -> None:
    emitter_token, started_token, message_token, session_token = tokens
